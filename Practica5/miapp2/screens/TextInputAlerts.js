...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#fafafa', padding: 20, width: '100%', maxWidth: 480, alignSelf: 'center' },
  title: { fontSize: 22, fontWeight: '600', marginBottom: 20, color: '#222' },
  label: { fontSize: 13, color: '#666', marginTop: 12 },
  input: { borderWidth: 1, borderColor: '#ddd', borderRadius: 6, padding: 12, fontSize: 15, marginBottom: 4, backgroundColor: '#fff' },
